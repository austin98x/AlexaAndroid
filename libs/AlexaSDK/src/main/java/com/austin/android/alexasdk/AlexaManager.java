package com.austin.android.alexasdk;
...
import com.austin.android.alexasdk.callbacks.AuthorizationCallback;
import com.austin.android.alexasdk.data.Event;
import com.austin.android.alexasdk.interfaces.AvsException;
import com.austin.android.alexasdk.interfaces.AvsItem;
import com.austin.android.alexasdk.interfaces.AvsResponse;
import com.austin.android.alexasdk.interfaces.GenericSendEvent;
import com.austin.android.alexasdk.interfaces.audioplayer.AvsPlayAudioItem;
import com.austin.android.alexasdk.interfaces.response.ResponseParser;
import com.austin.android.alexasdk.interfaces.speechrecognizer.SpeechSendAudio;
import com.austin.android.alexasdk.interfaces.speechrecognizer.SpeechSendText;
import com.austin.android.alexasdk.interfaces.speechrecognizer.SpeechSendVoice;
import com.austin.android.alexasdk.interfaces.speechsynthesizer.AvsSpeakItem;
import com.austin.android.alexasdk.requestbody.DataRequestBody;
import com.austin.android.alexasdk.service.DownChannelService;
import com.austin.android.alexasdk.system.AndroidSystemHandler;
import com.austin.android.alexasdk.utility.Util;
...
import static com.austin.android.alexasdk.AuthorizationManager.createCodeVerifier;
import static com.austin.android.alexasdk.interfaces.response.ResponseParser.getBoundary;
import static com.austin.android.alexasdk.utility.Util.IDENTIFIER;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link com.austin.android.alexasdk.data.Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.austin.android.alexasdk.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.austin.android.alexasdk.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.austin.android.alexasdk.data.Event.Builder}
