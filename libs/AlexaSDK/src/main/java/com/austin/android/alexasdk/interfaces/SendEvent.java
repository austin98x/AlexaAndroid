...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.austin.android.alexasdk.data.Directive} or {@link com.austin.android.alexasdk.data.Event} URL
    ...
    /**
     * Get our JSON {@link com.austin.android.alexasdk.data.Event} for this call
     * @return the JSON representation of the {@link com.austin.android.alexasdk.data.Event}
     */
    @NotNull
