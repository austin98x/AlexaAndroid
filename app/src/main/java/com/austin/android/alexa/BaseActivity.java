...
import com.austin.android.alexasdk.audioplayer.AlexaAudioPlayer;
...
import com.austin.android.alexasdk.interfaces.audioplayer.AvsPlayContentItem;
...
import com.austin.android.alexa.actions.BaseListenerFragment;
...
public abstract class BaseActivity extends AppCompatActivity implements BaseListenerFragment.AvsListenerInterface{
    ...
    private void sendPlaybackStartedEvent(AvsItem item){
        alexaManager.sendPlaybackStartedEvent(item, 10000, null);
